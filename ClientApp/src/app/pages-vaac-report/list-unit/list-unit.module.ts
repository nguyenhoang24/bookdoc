...
const routes: VexRoutes = [
  {
    ...
    children: [
      ...
      { path: 'create', component: UnitCreateUpdateComponent },
      { path: 'edit/:id', component: UnitCreateUpdateComponent },
    ]
  }
];

@NgModule({
    declarations: [ListUnitComponent, UnitCreateUpdateComponent],
