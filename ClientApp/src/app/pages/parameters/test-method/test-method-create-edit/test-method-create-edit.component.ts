...
@Component({
  selector: 'vex-test-method-create-edit',
  templateUrl: './test-method-create-edit.component.html',
  styleUrls: ['./test-method-create-edit.component.scss']
})
export class TestMethodCreateEditComponent implements OnInit {
  id!: string;
  ...
  onSubmit() {
    ...
    this.service.saveTestMethod(treatmentRegimenStage)
      .subscribe({
        next: (response) => {
