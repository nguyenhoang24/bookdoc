...
import { CustomerTypeCreateEditComponent } from './customer-type-create-edit/customer-type-create-edit.component';
...
export class CustomerTypeComponent implements OnInit {
  ...
  reloadTable() {
    this.isLoading = true;
    this.service.pagingCustomerType(this.searchForm.value)
      .subscribe({
        next: (response) => {
  ...
  create() {
    this.dialog.open(CustomerTypeCreateEditComponent).afterClosed().subscribe(result => {
      this.reloadTable();
    });
  }
  ...
  delete(id: string) {
    this.service.deleteCustomerType(id)
      .subscribe({
        next: () => {
          this.reloadTable();
