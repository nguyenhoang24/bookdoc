...
@Component({
  ...
  templateUrl: './health-insurance-create-edit.component.html',
  styleUrls: ['./health-insurance-create-edit.component.scss']
})
export class HealthInsuranceCreateEditComponent implements OnInit {
  id!: string;
  ...
  onSubmit() {
    ...
    this.service.saveHealthInsurance(treatmentRegimenStage)
      .subscribe({
        next: (response) => {
