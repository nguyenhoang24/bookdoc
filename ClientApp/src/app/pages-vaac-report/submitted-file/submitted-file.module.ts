...
import { PatientInfomationComponent } from './patient-infomation/patient-infomation.component';
...
const routes: VexRoutes = [
  {
    path: '',
    children: [
      { path: '', component: SubmittedFileComponent },
      { path: 'list-patient/:id', component: ListPatientComponent},
      { path: 'patient-information/:id', component: PatientInfomationComponent}
    ]
  }
];

@NgModule({
    declarations: [SubmittedFileComponent, ListPatientComponent, PatientInfomationComponent],
...
export class SubmittedFileModule { }
